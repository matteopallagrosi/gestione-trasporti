...
extern void set_date(MYSQL_TIME *date, char *input);
extern void set_time(MYSQL_TIME *time, char *input);
extern void get_datetime(MYSQL_TIME datetime, char *output);
extern void get_date(MYSQL_TIME date, char *output);
